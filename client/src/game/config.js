...
// hp — разрушаемая (столько попаданий держит); без hp — капитальная.
// ВАЖНО: стены НЕ прячут от засвета (виден силуэт за стеной), но блокируют выстрел.
export const WALLS = [
  // — центр: лёгкие укрытия, разрушаемые
  { dx: -90, dy: -30, w: 180, h: 44, hp: 3 }, // центральное укрытие
  ...
  // — руины (юг): хлипкие обломки, разрушаемые
  { dx: 70, dy: 380, w: 260, h: 44, hp: 3 },
  { dx: 300, dy: 300, w: 44, h: 200, hp: 3 },
  { dx: 480, dy: 560, w: 160, h: 40, hp: 2 },
  { dx: -260, dy: 620, w: 40, h: 150, hp: 2 },
