...
export const ENEMY_AI = {
  ...
  dodgeFactor: 0.5, // полный ход цели срезает шанс до hitChance*(1-0.5) — движение спасает сильнее (крутись = уходи)
...
export const VET = {
  ...
  hitMult: 1.3, // ×шанс попадания на максимуме (0.42 → ~0.55)
...
export const ENEMY_EDGE = {
  hitMult: 1.2, // ×шанс попадания вражеских ботов в PvE
