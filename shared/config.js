...
export const VET = {
  ...
  hitMult: 1.5, // ×шанс попадания на максимуме (плейтест: подняли 1.3→1.5 — ветераны раскатывали ботов)
  dmgMult: 1.6, // ×УРОН ботов на максимуме vet (плейтест: ветеранов «не пробивали» — боты в упор не дамажили прокачанный HP)
...
export const ENEMY_EDGE = {
  hitMult: 1.4, // ×шанс попадания вражеских ботов в PvE (плейтест: 1.2→1.4 — соло-бой был слишком лёгким)
...
export const ARMOR = {
  ...
  byClass: { light: 0.16, medium: 0.3, heavy: 0.5 }, // масштаб шанса; пик (идеальный ромб) ≈ база×0.9
  maxBlock: 0.55, // потолок шанса блока (ромб тяжа держит до ~45-50%)
