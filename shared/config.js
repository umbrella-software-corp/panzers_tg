...
export const ARMOR = {
  ...
  nopenMult: 0.35, // доля урона при «не пробил» (фидбек #26 «выстрелы в никуда»: 0.2→0.35 — блок чипует, не обнуляет)
  ricochetShare: 0.4, // из блоков 40% — рикошет (0 урона), 60% — «не пробил» (было 62/38 → меньше выстрелов «в молоко»; попадание почти всегда что-то снимает)
}
